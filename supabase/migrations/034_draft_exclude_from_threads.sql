-- Exclude draft replies (raw_payload->>'source' = 'draft') from thread counts and listings.
-- Drafts are saved as direction='OUT' with raw_payload.source='draft' to satisfy
-- the CHECK (direction IN ('IN','OUT')) constraint.
