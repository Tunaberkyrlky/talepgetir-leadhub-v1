...
### WP12 — Wizard'a geri-dönüş: kurulum yarım kalırsa keşfedilebilirlik — ✅ **BİTTİ → SHIP + MERGE'LENDİ** (2026-07-13, insan incelemesi bulgusu; commit `bf4ea08`, `ssalihyetim/TG-Research`'e merge `9735c19`, detay `04_ILERLEME.md §4.35-4.36`)
...
### WP13 — "Company Knowledge": wizard dışı manuel + AI-promptlu revizyon yüzeyi — ✅ **BİTTİ → SHIP + MERGE'LENDİ** (2026-07-13, kullanıcı talebi; kapsam aynı gün 4 paralel agent'lı TAM domain denetimiyle genişletildi, kanıt `04_ILERLEME.md §4.33`; implementasyon+3-tur codex review detayı `04_ILERLEME.md §4.35`, commit'ler `7cc9ba5`/`fb27aec`/`689244d`, `ssalihyetim/TG-Research`'e merge `9735c19` — **DİKKAT: migration 131+132 HENÜZ HİÇBİR DB'YE APPLY EDİLMEDİ, deploy öncesi staging'e uygulanmalı, bkz. §4.36**)
