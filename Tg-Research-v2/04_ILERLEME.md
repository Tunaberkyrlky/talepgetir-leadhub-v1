...
Son güncelleme: **2026-07-08** (WP1 BİTTİ → codex SHIP; WP2 BİTTİ → codex SHIP; **WP3 BİTTİ → codex SHIP** — 2-lens 1×P1+3×P2 + codex 3×P1+2×P2 hepsi düzeltildi, final verify SHIP). Branch: `ssalihyetim/TG-Research` (worktree). **Commit edilmedi** (mandate: sadece istenince commit).
