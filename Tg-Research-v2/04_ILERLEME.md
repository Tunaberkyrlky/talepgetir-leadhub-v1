...
Son güncelleme: **2026-07-09** (WP1-WP3 SHIP + **commit `aefb98b`**; **WP4 BİTTİ → codex SHIP** — 2-lens 1×P2+5×P3 + codex 1×P1+2×P2 + verify 1×P1+2×P2, hepsi düzeltildi, final SHIP). Branch: `ssalihyetim/TG-Research` (worktree).
